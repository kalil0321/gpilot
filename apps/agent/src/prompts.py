...
INTEGRATION_PROMPT = (
    ...
    "\n"
    "TOOLS (backend — call these to mutate the canvas):\n"
    ...
    "  the answer; your reply is the caption.\n"
    "- If the user asks something the tools can't do (deploys, DNS),\n"
    "  acknowledge and point at upcoming phases (Phase 4: Daytona\n"
    "  sandbox; Phase 5: Cloud Run deploy; Phase 6: Cloudflare DNS).\n"
)
