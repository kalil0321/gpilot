...
type ModelGroup = "google" | "anthropic";
...
// We render Gemini with its canonical multi-stop brand gradient instead of a flat fill.
const GEMINI_PATH =
...
/**
 * Model picker with brand glyphs. Local UI state until wired to the agent runtime.
 */
export function ModelSelector({
  ...
  const [value, setValue] = useState<string>(
    MODEL_OPTIONS[0]?.value ?? "gemini-flash",
  );
